...
{
    public class MemoryWriterFixture
    {
        public byte[] Buffer { get; private set; }
        public TorrentFile SingleFile { get; private set; }
        public TorrentFile[] MultiFile { get; private set; }

        public int PieceLength { get; private set; }
        public long TorrentSize { get; private set; }

        public MemoryWriterFixture()
        {
    ...
    public class MemoryWriterTests
    {
        ...
        public MemoryWriterTests(MemoryWriterFixture mwf)
        {
            pieceLength = mwf.PieceLength;
            singleFile = mwf.SingleFile;
            multiFile = mwf.MultiFile;
            buffer = mwf.Buffer;
            torrentSize = mwf.TorrentSize;
        }
