...
{
    public class TestEncryptionFixture : IDisposable
    {
        public TestRig Rig { get; private set; }

        public TestEncryptionFixture()
        {
    ...
    public class TestEncryption:IDisposable,IClassFixture<TestEncryptionFixture>
    {
        ...
        public TestEncryption(TestEncryptionFixture f)
        {
            rig = f.Rig;
        }
